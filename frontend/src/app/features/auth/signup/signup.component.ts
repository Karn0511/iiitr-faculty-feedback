      ...
      <div class="relative w-full max-w-lg animate-slide-up">
        ...
        <div class="text-center mb-6">
          <div class="inline-flex items-center justify-center w-14 h-14 mb-3">
            <img src="https://upload.wikimedia.org/wikipedia/commons/e/ee/Indian_Institute_of_Information_Technology%2C_Ranchi_Logo.png" class="w-12 h-12 object-contain" alt="IIIT Ranchi Official Logo" />
          </div>
