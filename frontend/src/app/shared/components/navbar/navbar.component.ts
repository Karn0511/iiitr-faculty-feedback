        ...
        <div class="flex items-center justify-between h-16">
          ...
          <a routerLink="/" class="flex items-center gap-3 group">
            <div class="w-9 h-9 flex items-center justify-center flex-shrink-0">
              <img src="https://upload.wikimedia.org/wikipedia/commons/e/ee/Indian_Institute_of_Information_Technology%2C_Ranchi_Logo.png" class="w-8 h-8 object-contain" alt="IIIT Ranchi Brand Logo" />
            </div>
